...
## [0.6.1](https://github.com/wsdjeg/nvim-plug/compare/v0.6.0...v0.6.1) (2026-07-18)
...
* **installer:** guard process count increment in download_raw and install_plugin ([7ed00de](https://github.com/wsdjeg/nvim-plug/commit/7ed00de346be05f75be73173aacf089be8afbb4b))
* **installer:** use H.luarocks_install for rocks plugin update ([cd25480](https://github.com/wsdjeg/nvim-plug/commit/cd254801732311d5ae0c4eef237186b1fb09d6f1))
* **installer:** use task[3] instead of tasks[3] in queue runners ([88a33b8](https://github.com/wsdjeg/nvim-plug/commit/88a33b84f55192f3ea820f4dbc7cbfbfaecbd8e7))
* negate the condition so close() actually closes the window. ([8d432b1](https://github.com/wsdjeg/nvim-plug/commit/8d432b138e75f57f340dec851fe73e6c7f5ae8da))
* remove lower() function ([eaace1e](https://github.com/wsdjeg/nvim-plug/commit/eaace1e0429e1762038ecf66ad2f104f969c3764))
* **rocks:** use forward slash in package.path and package.cpath ([6224ea9](https://github.com/wsdjeg/nvim-plug/commit/6224ea9a36516d8820a75cac111698c3747f41ef))
* **test:** register dofile return values as globals for LuaUnit ([e27a8a6](https://github.com/wsdjeg/nvim-plug/commit/e27a8a62b8e76949a5a2b310c4d762fe54bcfdca))
* **ui:** correct inverted guard condition in close() ([8d432b1](https://github.com/wsdjeg/nvim-plug/commit/8d432b138e75f57f340dec851fe73e6c7f5ae8da))
* **ui:** count failed plugins as done in count_done ([2a7efc7](https://github.com/wsdjeg/nvim-plug/commit/2a7efc7b23c75a70580c700250949c9c709783a7))
...
* **rocks:** remove duplicate unify_path, use plug.util ([74afea2](https://github.com/wsdjeg/nvim-plug/commit/74afea2e3af040db8918db63b8ab88b2c804618c))


### Documentation

* add AGENTS.md for project assistant ([fe15468](https://github.com/wsdjeg/nvim-plug/commit/fe15468d955f87a8f58076d46910412d0e1446fc))
* **readme:** improved grammar, spelling and documentation ([b1e4f39](https://github.com/wsdjeg/nvim-plug/commit/b1e4f390ed7dd3612fe63429541a63bbd3596bae))
* update readme ([cca4e65](https://github.com/wsdjeg/nvim-plug/commit/cca4e654128dee182d8fd7f5ea7014ca5ff2c909))


### Tests

* add PluginSpec parsing tests, fix module name gsub bug ([43914ec](https://github.com/wsdjeg/nvim-plug/commit/43914ec58cd52fee0e39ecc972e1be68a7c71d76))
